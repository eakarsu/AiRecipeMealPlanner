...
export default function CfNutritionistintheloopMealPlanning() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-nutritionistintheloop-meal-planning', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>Nutritionist-in-the-loop meal planning</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AiRecipeMealPlanner - Custom feature</p>
