...
export default function GapNoDietaryrestrictionmapperRestrictionsIng() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-dietaryrestrictionmapper-restrictions-ing', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No /dietary-restriction-mapper (restrictions → ingredient exclusion list)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AiRecipeMealPlanner - Gap feature</p>
