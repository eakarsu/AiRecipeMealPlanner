...
const FEATURE_SLUG = 'no-dietaryrestrictionmapper-restrictions-ing';
const FEATURE_TITLE = 'No /dietary-restriction-mapper (restrictions → ingredient exclusion list)';
const PROJECT = 'AiRecipeMealPlanner';
